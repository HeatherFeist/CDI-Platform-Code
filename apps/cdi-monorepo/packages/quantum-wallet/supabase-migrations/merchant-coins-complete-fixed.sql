-- Merchant Coins Complete Schema Migration (FIXED)
...
-- ============================================================================
-- DROP EXISTING POLICIES AND TABLES (Clean slate approach)
-- ============================================================================
...
DROP POLICY IF EXISTS "Users can view own fiat accounts" ON fiat_accounts;
DROP POLICY IF EXISTS "Users can manage own fiat accounts" ON fiat_accounts;
DROP POLICY IF EXISTS "Users can view own fiat transactions" ON fiat_transactions;
DROP POLICY IF EXISTS "Users can view own crypto wallets" ON crypto_wallets;
DROP POLICY IF EXISTS "Users can manage own crypto wallets" ON crypto_wallets;
DROP POLICY IF EXISTS "Users can view own crypto balances" ON crypto_balances;
...
DROP FUNCTION IF EXISTS update_project_funds();
