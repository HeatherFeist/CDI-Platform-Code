...
export class CustomerService {
    ...
    async updateCustomer(customerId: string, updates: Partial<Customer>): Promise<void> {
        ...
        if (updates.communicationPreferences !== undefined) mappedUpdates.communication_preferences = updates.communicationPreferences;
        if (updates.source !== undefined) mappedUpdates.source = updates.source;
        if (updates.tags !== undefined) mappedUpdates.tags = updates.tags;
        if (updates.lastContactDate !== undefined) mappedUpdates.last_contact_date = updates.lastContactDate;
        if (updates.totalSpent !== undefined) mappedUpdates.total_spent = updates.totalSpent;
        if (updates.projectCount !== undefined) mappedUpdates.project_count = updates.projectCount;
