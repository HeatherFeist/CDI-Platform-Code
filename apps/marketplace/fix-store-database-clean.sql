-- Fix Store Database Issues (Clean Version)
...
SELECT 
  CASE 
    ...
    THEN 'SUCCESS: listing_type column exists'
    ELSE 'ERROR: listing_type column MISSING'
  ...
  CASE 
    ...
    THEN 'SUCCESS: stock_quantity column exists'
    ELSE 'ERROR: stock_quantity column MISSING'
  ...
  CASE 
    ...
    THEN 'SUCCESS: allow_offers column exists'
    ELSE 'ERROR: allow_offers column MISSING'
