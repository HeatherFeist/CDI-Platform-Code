...
-- Run AFTER: add-mentor-commission-system.sql
-- =====================================================================================
...
/*
-- Step 1: New non-member signs up for subscription
SELECT sync_subscription_from_stripe(
  'sub_1234567890',
  'cus_1234567890',
  'buyer@example.com',
  'active',
...
-- Creates subscription record and updates profile

-- Step 2: Monthly payment succeeds
SELECT process_subscription_payment_success(
  'sub_1234567890',
  'pi_1234567890',
  29.99,
  'usd',
...
-- Records payment and processes mentor commission

-- View subscription dashboard
SELECT get_subscription_dashboard('subscriber-uuid-here');
*/

-- =====================================================================================
-- END OF SCHEMA
-- =====================================================================================</content>
<parameter name="filePath">c:\Users\heath\Downloads\constructive-designs-marketplace\add-subscription-system.sql