...
import { Heart, CreditCard, DollarSign, Users, Building2, Award, CheckCircle } from 'lucide-react';
import PayPalDonationButton from '../payment/PayPalDonationButton';
        ...
        <div className="max-w-2xl w-full bg-white rounded-2xl shadow-lg p-8 text-center">
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
            <p className="text-green-900">
              {frequency === 'monthly' ? (
                <>
                  Your monthly donation will provide <strong>${donationDetails?.amount * 12}</strong> annually
                  to support our programs and create lasting impact in our community.
                </>
              ) : (
                <>
                  Your donation will directly support our mission to create economic opportunities
          ...
          <p className="text-sm text-gray-600 mb-6">
            A receipt has been sent to your email. Your donation is tax-deductible.<br />
            <strong>EIN: 86-3183952</strong>
          </p>
          <button
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button
                    ...
                    className={`p-4 rounded-lg border-2 font-semibold transition ${frequency === 'once'
                  ...
                  <button
                    ...
                    className={`p-4 rounded-lg border-2 font-semibold transition ${frequency === 'monthly'
                        ? 'border-green-600 bg-green-50 text-green-700'
                        : 'border-gray-200 hover:border-gray-300'
                      }`}
                  >
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-3 sm:grid-cols-5 gap-3 mb-4">
                  {presetAmounts.map((preset) => (
                    <button
                      ...
                      className={`p-4 rounded-lg border-2 font-semibold transition ${amount === preset && !customAmount
                          ? 'border-green-600 bg-green-50 text-green-700'
                          : 'border-gray-200 hover:border-gray-300'
                        }`}
                    >
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg border-2 font-semibold transition ${customAmount
                        ? 'border-green-600 bg-green-50 text-green-700'
                        : 'border-gray-200 hover:border-gray-300'
                      }`}
                  >
